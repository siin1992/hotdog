...
<section class="container">
		<br/><center><h1>객실 상세사진 등록</h1></center>
			<article class="half">
	 		    <div class="content">
				            <div class="signin-cont cont">
								<form action="insertRoomImage" method="post" enctype="multipart/form-data">
									<input type="text" name="RI_Name" class="inpt" required="required" placeholder="객실이름"/> <br/>
									<input type="file" name="RI_Path" class="inpt" required="required" placeholder="사진첨부"/> <br/><br/>	
